...
#if we didn't hardcode the Jamf Pro paswroed, prompt the user for the Jamf Pro password
...
#update the site for computer with id 44
/usr/bin/curl -s \
-H "Authorization: Bearer $bearerToken" \
-H "content-type: application/xml" \
"$jamfProURL"/JSSResource/computers/id/44 \
-X PUT \
-d "<computer><general><site><name>newSiteHere</name></site></general></computer>"